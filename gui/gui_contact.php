...
<section class="contact-section contact-variant-glass-premium-dark" id="contact">
    <div class="container px-4 px-lg-5">
        <div class="text-center mb-5">
            <p class="section-kicker">Agenda tu cita</p>
            <h2 class="contact-title">Reserva una valoracion</h2>
            <p class="contact-subtitle">Una experiencia visual orientada a generar confianza inmediata y facilitar el primer contacto.</p>
        </div>
